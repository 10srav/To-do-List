...
export default function Sidebar({ view, setView, calendarView, setCalendarView }: SidebarProps) {
  ...
  const handleViewChange = (viewId: string) => {
    setView(viewId as 'list' | 'calendar');
  };
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <h2 className="text-xl font-bold text-primary-600">TodoApp</h2>
      </div>
